...
values('abc123','987xyz','ming','ming@abc123.co.kr','123-456','서울 관악구','블라블라','123-4567-8910');
...
insert into board2 (userid, title, contents, ipaddr)
values ('abc123', '구글, 사람처럼 진찰하는 "의료 AI 챗봇" 테스트',
...
insert into board2 (userid, title, contents, ipaddr)
values ('abc123', '[공식발표] 파리생제르맹 이강인 영입. 28년 까지 계약',
